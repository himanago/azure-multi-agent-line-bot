...
param LINE_CHANNEL_ACCESS_TOKEN string

@description('Azure AI Foundry project endpoint')
param AZURE_AI_PROJECT_ENDPOINT string

@description('Azure AI Agent ID')
param AZURE_AI_AGENT_ID string

@description('Azure AI Service Name (optional, for direct role assignment)')
...
module api './app/api.bicep' = {
  ...
  params: {
    ...
    azureAiServiceName: azureAiServiceName
  }
}
...
// Cognitive Services User role assignment at subscription scope
resource cognitiveServicesUserRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(subscription().id, 'cognitiveservicesuser', environmentName)
  properties: {
...
output AZURE_AI_PROJECT_ENDPOINT string = AZURE_AI_PROJECT_ENDPOINT
output AZURE_AI_AGENT_ID string = AZURE_AI_AGENT_ID
